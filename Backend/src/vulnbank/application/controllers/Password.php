...
class Password extends CI_Controller
{
	...
	public function forgot()
	{
		...
		if ($parsed['status_code'] != 'ALLOK1')
			...
			if ($is_valid_param['status_code'] == "ALLOK1") {
				...
				$user_details_id = $this->Model_passwd->get_userdetailid($parsed);
	...
	public function reset()
	{
		...
		if ($parsed['status_code'] != 'ALLOK1')
			...
			$userid = $this->Model_passwd->get_userdetailid($parsed);
			if ($is_valid_param['status_code'] == "ALLOK1") {
				$reset_status = $this->Model_passwd->reset_user_passwd($userid, $parsed);
	...
	public function verifyuser()
	{
		...
		if ($parsed['status_code'] != 'ALLOK1')
			...
			if ($is_valid_param['status_code'] == "ALLOK1") {
				$userid = $this->Model_passwd->get_userdetailid($parsed);
				$otp_status = $this->Model_otp->check_otp($userid, $parsed);
